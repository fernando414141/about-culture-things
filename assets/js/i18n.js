...
const i18n = {
  en: {
    ...
    "faq7-q": "What happens if it rains?",
    "faq7-a": "Rita adapts the route — swapping outdoor viewpoints for covered stops or quieter indoor areas. Tours can also be rescheduled with 24 hours' notice at no cost.",
    "faq8-q": "How much walking is involved?",
    "faq8-a": "Most of the day is by private car between stops. Expect short walks at viewpoints and palaces; Rita adapts the pace for children, seniors, and your group's comfort.",
    "faq9-q": "Where does pickup happen?",
    "faq9-a": "Rita collects you from your hotel or accommodation in Lisbon at an agreed time. Exact pickup details are confirmed together when you reserve.",
  ...
  es: {
    ...
    "faq7-q": "¿Qué pasa si llueve?",
    "faq7-a": "Rita adapta la ruta — cambiando miradores al aire libre por paradas cubiertas o zonas interiores más tranquilas. También se puede reagendar con 24 horas de antelación sin coste.",
    "faq8-q": "¿Cuánto hay que caminar?",
    "faq8-a": "La mayor parte del día es en coche privado entre paradas. Habrá caminatas cortas en miradores y palacios; Rita adapta el ritmo para niños, mayores y la comodidad de tu grupo.",
    "faq9-q": "¿Dónde es la recogida?",
    "faq9-a": "Rita te recoge en tu hotel o alojamiento en Lisboa a la hora acordada. Los detalles exactos se confirman juntos al reservar.",
  ...
  pt: {
    ...
    "faq7-q": "E se chover?",
    "faq7-a": "A Rita adapta a rota — trocando miradouros ao ar livre por paragens cobertas ou zonas interiores mais calmas. Também é possível reagendar com 24 horas de antecedência sem custo.",
    "faq8-q": "Quanto é preciso caminhar?",
    "faq8-a": "A maior parte do dia é de carro privado entre paragens. Espera caminhadas curtas em miradouros e palácios; a Rita adapta o ritmo para crianças, idosos e o conforto do teu grupo.",
    "faq9-q": "Onde é a recolha?",
    "faq9-a": "A Rita recolhe-te no teu hotel ou alojamento em Lisboa à hora combinada. Os detalhes exatos são confirmados juntos quando reservas.",
