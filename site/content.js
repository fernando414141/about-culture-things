  ...
  content: {
    en: {
      ...
      offers: {
        ...
        currencyNote: 'Direct website rates, per person and charged in EUR. Shared departures are confirmed from 4 travellers. No marketplace commission is added.',
      ...
      faq: {
        ...
        items: [
          ...
          { question: 'How do shared departures work?', answer: 'Prices are per person and departures are confirmed from 4 travellers. Each traveller has an assigned seat in the nine-seat Mercedes-Benz Vito—a luxury van, not a coach. Larger parties can be arranged with additional vehicles, subject to availability.' },
    ...
    es: {
      ...
      offers: {
        ...
        currencyNote: 'Tarifas directas del website, por persona y en EUR. Las salidas se confirman desde 4 viajeros. No añadimos comisión de marketplace.',
      ...
      faq: {
        ...
        items: [
          ...
          { question: '¿Cómo funcionan las salidas compartidas?', answer: 'Los precios son por persona y las salidas se confirman desde 4 viajeros. Cada viajero tiene una plaza asignada en la Mercedes-Benz Vito de nueve asientos: una van de lujo, no un autobús. Para grupos mayores podemos coordinar vehículos adicionales, sujetos a disponibilidad.' },
    ...
    pt: {
      ...
      offers: {
        ...
        currencyNote: 'Tarifas diretas do website, por pessoa e em EUR. As saídas são confirmadas a partir de 4 viajantes. Não acrescentamos comissão de marketplace.',
      ...
      faq: {
        ...
        items: [
          ...
          { question: 'Como funcionam as saídas partilhadas?', answer: 'Os preços são por pessoa e as saídas são confirmadas a partir de 4 viajantes. Cada viajante tem um lugar atribuído na Mercedes-Benz Vito de nove lugares: uma van de luxo, não um autocarro. Para grupos maiores podemos coordenar veículos adicionais, sujeitos a disponibilidade.' },
