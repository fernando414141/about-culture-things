(async function () {
  ...
  try {
    ...
    root.innerHTML='<p class="eyebrow">Booking verification</p><h1>We could not verify your payment.</h1><p>Please check your confirmation email before trying another payment. Contact us with reference <strong>'+esc(ref)+'</strong> if you need assistance.</p><a class="button" href="mailto:aboutculturethings@gmail.com?subject='+encodeURIComponent('Booking '+ref)+'">Contact us</a>';
  }
}());
