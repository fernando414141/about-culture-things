(function () {
  ...
  const COPY = {
    ...
    es: {
      ...
      reviewButton: 'Reseñar en Tripadvisor', reviewNote: 'Para un pequeño negocio local supone una gran diferencia.',
    ...
    pt: {
      ...
      reviewButton: 'Avaliar no Tripadvisor', reviewNote: 'Faz uma enorme diferença para um pequeno negócio local.',
      ...
      customButton: 'Perguntar-nos', customMessage: 'Olá, About Culture Things! Obrigada novamente pelo tour. Gostaria de conhecer outro lugar em Portugal...',
