(function () {
  ...
  const COPY = {
    en: {
      ...
      experiencesText: 'Three small-group day tours to see more.', experienceButton: 'View tour',
    ...
    es: {
      ...
      experiencesText: 'Tres tours de día en grupo pequeño para seguir descubriendo.', experienceButton: 'Ver tour',
    ...
    pt: {
      ...
      experiencesText: 'Três tours de dia em grupo pequeno para continuar a descobrir.', experienceButton: 'Ver tour',
