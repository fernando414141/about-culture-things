...
(function () {
  ...
  function flatten(lang) {
    ...
    return {
      ...
      'language-selector': c.ui && c.ui.languageSelector,
      ...
      'meta-keywords': c.seo && c.seo.keywords,
      'meta-og-title': c.seo && (c.seo.ogTitle || c.seo.title),
      'meta-og-description': c.seo && (c.seo.ogDescription || c.seo.description),
      'meta-twitter-title': c.seo && (c.seo.twitterTitle || c.seo.title),
      'meta-twitter-description': c.seo && (c.seo.twitterDescription || c.seo.description),
      ...
      'cta-tour1': c.ctas && (c.ctas.tour1 || c.ctas.offer),
      'cta-tour2': c.ctas && (c.ctas.tour2 || c.ctas.offer),
      ...
      'tours-currency-note': c.offers && c.offers.currencyNote,
      ...
      'foot-tripadvisor': socialLabels.tripadvisor,
