...
module.exports={TOURS,LANGUAGES,MIN_GUESTS,MAX_GUESTS,BOOKING_CUTOFF_HOUR,BOOKING_CUTOFF_MINUTE,MIN_ADVANCE_HOURS,TOUR_START_TIME,BOOKING_TIME_ZONE,SITE_URL,stripe,text,email,reference,tourById,minDate,validDate,sendConfirmation,bookingFromSession};