...
module.exports={TOURS,LANGUAGES,BOOKING_CUTOFF_HOUR,BOOKING_TIME_ZONE,SITE_URL,stripe,text,email,reference,tourById,minDate,validDate,sendConfirmation,bookingFromSession};
